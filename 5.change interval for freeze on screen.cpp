    ...
    for(;;) {
        ...
        if (currentCarouselState == LOW && lastCarouselState == HIGH) {
            ...
            if (pressDuration < 400) {
                ...
                float change = (pressDuration < 2000) ? 1.0f : -1.0f;
                effectMemory[activeEffectMode] += change;
        ...
        if (isFeedbackActive) { 
            ...
            feedbackRamp = feedbackRamp - 0.02f; 
