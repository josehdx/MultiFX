// v1.15 Lilygo Release Controller (PSRAM Display Acceleration Edition)
        ...
        if(__builtin_expect(bytesRead>0, 1)) {
            ...
            if(__builtin_expect(framesRead == HOP_SIZE, 1)) {
                ...
                for(int i=0; i<framesRead; i++) {
                    ...
                    // 1024-SAMPLE SPATIAL DIFFUSION (CHORUS/PAD)
                    ...
                    diffuserIdx = (diffuserIdx + 1) & 1023; // Masked to 1024
